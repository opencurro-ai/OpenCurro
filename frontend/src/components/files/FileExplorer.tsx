  ...
  return (
    <div>
      ...
      >
        ...
        {node.type === 'dir' ? (open ? <FolderOpen className="size-4 text-cyan-200" /> : <Folder className="size-4 text-cyan-200" />) : <span className="size-4 rounded-sm border border-white/15 bg-white/8" />}
